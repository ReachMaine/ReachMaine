<?php
// [reach_blog_posts]
function reach_shortcode_latest_from_blog($atts, $content = null) {
	global $flatsome_opt;
	$element_id = rand();
							    ...
							    <a href="<?php the_permalink() ?>">
							      <div class="ux-box-image">
								        <div class="entry-image-attachment" style="max-height:<?php echo  $image_height; ?>;overflow:hidden;">
											<?php 
											if (get_post_meta(get_the_ID(), 'thumbnail-gif', true) == 'yes' ) { 
...
function reach_string_limit_words($string, $word_limit) {
...
add_shortcode("reach_blog_posts", "reach_shortcode_latest_from_blog");
