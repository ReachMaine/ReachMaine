 ...
 */
/* mods 
* zig - 19Feb16 - check for hide-featured-image custom field before displaying thumbnail
*/
global $flatsome_opt;
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( has_post_thumbnail() && (get_post_meta(get_the_ID(), 'thumbnail-gif', true) != 'yes')) { // check if the post has a Post Thumbnail assigned to it. ?>
	...
	<div class="entry-content">
		...
		<?php
			wp_link_pages( array(
				...
				'link_before' => '<div class="button medium secondary">',
				'link_after' => '</div>',
				'after'  => '</div>',
				'next_or_number' => 'next',
				'nextpagelink' => 'Continue Reading >>',
