...
/* 
*  zig 18Feb2016 - use full for image if post_meta gif_thumbnail = 'true' in blog-list
*/ 
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="large-4 columns">
        <div class="entry-image zig">
        	<a href="<?php the_permalink();?>">
            <?php if (get_post_meta(get_the_ID(), 'thumbnail-gif', true) == 'yes' ) { 
